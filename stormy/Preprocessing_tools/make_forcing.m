...
create_forcing(frcname,grdname,ROMS_title,...
        coads_time,coads_time,coads_time,coads_time,...
        coads_time,coads_time,coads_time,...
        coads_cycle,coads_cycle,coads_cycle,coads_cycle,...
...
for tindex=1:length(coads_time)
  time=nc{'slp_time'}(tindex);
  nc{'slp'}(tindex,:,:)=ext_data(slp_file,slp_name,tindex,...
                                  lon,lat,time,Roa,1);
end
...
if makeplot==1
  ...
  figure
  test_forcing(frcname,grdname,'slp',[1 4 7 10],3,coastfileplot)
end
%
% End
%
