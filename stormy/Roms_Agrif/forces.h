! $Id: forces.h 697 2011-04-11 12:35:17Z gcambon $
!
!======================================================================
...
!  ATMOSPERIC PRESSURE FOR 2D BAROTROPIC MODEL.
!--------------------------------------------------------------------
	 real slp(GLOBAL_2D_ARRAY)
	 common /forces_slp/slp

         real slpg(GLOBAL_2D_ARRAY,2)
         common /slpdat_slpg/slpg

         real slpp(2), slp_time(2)
         real slp_cycle,slp_scale
         integer itslp, slp_ncycle, slp_rec,
