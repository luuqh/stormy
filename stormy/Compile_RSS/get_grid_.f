      ...
      implicit none
      character*1 char1
      integer*4 ierr, ncid, varid, lstr, lenstr, checkdims, nf_fread
     ...
     &                          'Spherical grid detected.'
      ...
      if (ierr .eq. nf_noerr) then
        ierr=nf_fread(h (-1,-1), ncid, varid, 0, r2dvar)
        if (ierr .ne. nf_noerr) then
      ...
      if (ierr .eq. nf_noerr) then
        ierr=nf_fread (f(-1,-1), ncid, varid, 0, r2dvar)
        if (ierr .ne. nf_noerr) then
      ...
      if (ierr .eq. nf_noerr) then
        ierr=nf_fread (pm(-1,-1), ncid, varid, 0, r2dvar)
        if (ierr .ne. nf_noerr) then
      ...
      if (ierr .eq. nf_noerr) then
        ierr=nf_fread (pn(-1,-1), ncid, varid, 0, r2dvar)
        if (ierr .ne. nf_noerr) then
      ...
      if (ierr .eq. nf_noerr) then
        ierr=nf_fread (lonr(-1,-1), ncid, varid, 0, r2dvar)
        if (ierr .ne. nf_noerr) then
      ...
      if (ierr .eq. nf_noerr) then
        ierr=nf_fread (latr(-1,-1), ncid, varid, 0, r2dvar)
        if (ierr .ne. nf_noerr) then
      ...
      if (ierr .eq. nf_noerr) then
        ierr=nf_fread (angler(-1,-1), ncid, varid, 0, r2dvar)
        if (ierr .ne. nf_noerr) then
      ...
      if (ierr .eq. nf_noerr) then
        ierr=nf_fread(rmask(-1,-1), ncid, varid, 0, r2dvar)
        if (ierr .ne. nf_noerr) then
