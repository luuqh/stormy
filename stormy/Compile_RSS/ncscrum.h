! $Id: ncscrum.h 697 2011-04-11 12:35:17Z gcambon $
!
!======================================================================
...
# ifdef SEDIMENT
      ...
      parameter (indxSed=indxSUSTR+26,
...
#  ifdef SEDIMENT
      parameter (indxBBL=indxSUSTR+27+NST,
#  else
      parameter (indxBBL=indxSUSTR+27, 
#  endif
...
!   ntslp   sealevel pressure  in current forcing file
!
